...
Every acting command supports it. It resolves everything and executes nothing:
...
`init`, `server add`, `anonymize init`, `db pull`, `files pull`, `doctor`, `logs`. WordPress. MySQL and PostgreSQL. The Shim.
